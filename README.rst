...
A project for document similarity matching based on bloom filter
...
To run the tests, enter the document_similarity/tests directory and run the following commands::
